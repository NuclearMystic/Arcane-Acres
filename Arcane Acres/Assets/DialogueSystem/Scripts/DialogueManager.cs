...
namespace DialogueSystem
{
    public class DialogueManager : MonoBehaviour
    {
        ...
        /* Use this method by setting the initial dialogue tree for starting a conversation. If the provided 
         * triggers don't meet your requirements, you can call this method from another script with the correct 
         * dialogue tree parameter, and it will function the same way.*/
        ...
        private int FindStartNodeIndex(DialogueTree dialogueTree)
        {
            ...
            return 0; // Default to first node if no conditions are met
        }
